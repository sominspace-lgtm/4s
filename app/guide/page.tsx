  ...
  return (
    <main style={{ colorScheme: 'light', maxWidth: '760px', margin: '0 auto', padding: '2.5rem 1.25rem 5rem' }}>
      ...
      <p style={{ fontSize: '0.95rem', color: 'var(--text)', lineHeight: 1.7, marginBottom: '2.5rem', fontWeight: 300 }}>
        ...
        right now and stays out of the way the rest of the time. Everything is private by default, and you share only what you choose.
      </p>
      ...
      <Section id="notes" kicker="write it down" title="Notes">
        <Card>
          A real note with a title and body, as long or short as it needs to be. Pin the ones you keep coming back to.
      ...
      <Section id="money" kicker="stay ahead of it" title="Money">
        <Card>
          ...
          <strong style={{ color: 'var(--text)' }}> Buy Again</strong>, which is Refill Intelligence.
        </Card>
      ...
      <Section id="calendar" kicker="what's ahead" title="Calendar">
        <Card>
          ...
          dated tasks, renewals, refill run-outs, and gift dates. You see what&rsquo;s coming without leaving 4S.
      ...
      <Section id="household" kicker="shared living" title="Household">
        <Card>
          ...
          <strong style={{ color: 'var(--text)' }}> Upkeep</strong> keeps the chores and the care logs for Somi and the house.
      ...
      <Section id="places" kicker="don't lose track of it" title="Places">
        <Card>
          ...
          From Discord, no command needed: post a name or a maps link in #pins and it&rsquo;s saved, then react thumbs-up or thumbs-down on the bot&rsquo;s
      ...
      <Section id="ai" kicker="alive but quiet" title="AI features">
        <Card>
          ...
          Point it at a product label or a shopping link and it fills in the details. Only a light summary of your dashboard is ever sent
          (counts, titles, dates), never your note contents. Without a key, 4S falls back to its built-in rules automatically.
        </Card>
      </Section>
